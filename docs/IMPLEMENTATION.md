...
- Repository state: pnpm workspace, SolidJS + Vite desktop shell, Tauri v2 shell, and Rust-source IPC contracts with generated TS bindings are in source and verification-clean
