...
use crate::models::{
    ...
    RelayCodePatchEdit, RelayDiagnostics, RelayDocumentSearchCoreConceptHint,
    RelayDocumentSearchEvidence, RelayDocumentSearchIntent, RelayDocumentSearchQueryPlanHints,
    RelayDocumentSearchRequest, RelayDocumentSearchResponse, RelayDocumentSearchThoroughness,
...
pub fn render_ipc_generated_ts() -> String {
    let sections = [
        ...
        decl::<RelayDocumentSearchCoreConceptHint>(),
