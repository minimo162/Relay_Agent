...
//! Relay defaults live in [`CompactionConfig`]. Logic aligned with claw-code
//! `rust/crates/runtime/src/compact.rs` at the pin in `docs/CLAW_CODE_ALIGNMENT.md`
//! (`should_compact` window, merged re-compaction, continuation preamble parsing).
...
impl Default for CompactionConfig {
    fn default() -> Self {
        Self {
            // Slightly more tail than claw’s default (4) — documented in IMPLEMENTATION.md.
