...
<div class="btn-row">
  <button class="btn btn-secondary" type="button" on:click={onBack} disabled={busy || !reviewStepAvailable}>
    {backLabel}
  </button>
  <button class="btn btn-primary btn-save" type="button" on:click={onApprove} disabled={busy || !reviewStepAvailable}>
