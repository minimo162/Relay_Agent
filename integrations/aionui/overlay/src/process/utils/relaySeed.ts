...
export async function applyRelayProviderSeed(configFile: ConfigStore): Promise<void> {
  ...
  const keysToForce = [
    ...
    'relay.taskMode.required',
    'relay.taskMode.allowedModes',
    'relay.taskMode.modeByAssistantId',
    'relay.taskMode.sendWithoutMode',
    'relay.taskMode.promptTemplates',
    'relay.documentSearch.candidateFirst',
    'relay.documentSearch.preserveQueryExpansion',
    'relay.documentSearch.deferContentExtractionByDefault',
    'relay.documentSearch.candidateLimit',
    'relay.documentSearch.displayLimit',
    'relay.documentSearch.continuation',
