...
const RELAY_OFFICECLI_VERSION = '1.0.92';
const RELAY_OFFICECLI_URL = 'https://github.com/iOfficeAI/OfficeCLI/releases/download/v1.0.92/officecli-win-x64.exe';
const RELAY_OFFICECLI_SHA256 = 'ce5e4926dcfc766e467e92b207786822150a28930700f98334e10fe16ddc054a';
const RELAY_OFFICECLI_SIZE = 30777980;
...
const RELAY_SHARED_SEARCH_DEFAULTS = {
  ...
  RELAY_DOCUMENT_SEARCH_INDEX_DB: '1',
  RELAY_DOCUMENT_SEARCH_INDEX_DB_PATH: relayDocumentSearchUserDataPath('index-db', 'document-search.sqlite'),
  RELAY_DOCUMENT_SEARCH_INDEX_DB_PRIMARY_MODE: 'primary',
  RELAY_DOCUMENT_SEARCH_INDEX_DB_SEARCH_MAX_ROWS: '80',
  RELAY_PARSED_DOCUMENT_CACHE: '1',
  RELAY_PARSED_DOCUMENT_CACHE_DIR: relayDocumentSearchUserDataPath('parsed-document-cache'),
  RELAY_DOCUMENT_SEARCH_DERIVED_CONTENT_INDEX_CACHE: '1',
  RELAY_DOCUMENT_SEARCH_DERIVED_CONTENT_INDEX_DIR: relayDocumentSearchUserDataPath('derived-content-index'),
  RELAY_DOCUMENT_SEARCH_INDEX_COORDINATOR: '1',
  RELAY_DOCUMENT_SEARCH_INDEX_COORDINATOR_DIR: relayDocumentSearchUserDataPath('index-coordinator'),
  RELAY_DOCUMENT_SEARCH_FAILURE_REGISTRY_DIR: relayDocumentSearchUserDataPath('failure-registry'),
  RELAY_DOCUMENT_SEARCH_JOB_STORE: '1',
  RELAY_DOCUMENT_SEARCH_JOB_STORE_DIR: relayDocumentSearchUserDataPath('jobs'),
};
const GATEWAY_FILES = [
  'copilot_server.js',
  'copilot_server.mjs',
